...
// Use geocoding or style APIs — but not “tilesets” service like Mapbox
...
module.exports.createListing = async (req , res , next) => {
  ...
  console.log("response from Maptiler : " , response.data);
...
console.log("Geometry from maptiler : " , geometry);
